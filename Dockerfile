...
# Install forever to run node process in the background
RUN npm install -g forever

# Install Ninowalker's version of Rester
RUN pip install git+https://github.com/ninowalker/Rester.git@master
